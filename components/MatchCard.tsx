    ...
    return (
        <Card img={null} tag={null}>
            <div className="relative gap-16">
                ...
                <div className={`absolute right-[-70px] top-[0px] w-[150px] transform -rotate-320 bg-${(info.pickResult != null || info.pickResult != undefined) && info.pickResult == 'true' ? 'green' : info.pickResult == 'false' ? 'red' : 'grey'}-600 text-center font-bold text-white text-[10px] py-1`}>
